...
* If you are using this module in version < 8.0.2.0.0 and update it, any other
  ...
  1. Stop your server.
  2. Update only this module: ``odoo.py -u beds_cookie_notice``.
  3. Stop your server.
...
`here <https://github.com/OCA/website/issues/new?body=module:%20beds_cookie_notice%0Aversion:%208.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
